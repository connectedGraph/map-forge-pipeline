...
# ============================================================
# 风格模板池（8 个，可轮换）：背景设定 + 关卡点/连接/起始点身份。
# ============================================================
STYLE_POOL = [
    {
    ...
    },
    {
        "name": "desert-canyon",
        "label": "沙岩峡谷",
        "background": "炽热沙漠中的古老峡谷：橙红到金黄的层叠沙岩，风化的石柱、沙丘与烈日下的热浪。",
        "level": "峡谷岩壁上开凿出的砂岩石台，表面平整空旷。",
        "connection": "连接石台之间的干涸河床或横跨峡谷的悬索栈道。",
        "start": "峡谷入口处的行者营地。",
    },
    {
        "name": "frost-tundra",
        "label": "冰封冻土",
        "background": "极寒之地的冻土荒原：冷蓝到青白的冰雪覆盖，冰川裂隙、冰凌与天边微弱的极光。",
        "level": "冻土上凸起的冰封石座，表面干净平整。",
        "connection": "冰层之间的裂隙浮桥或飘动的极光带。",
        "start": "雪峰脚下的补给营地。",
    },
    {
        "name": "ember-volcano",
        "label": "炽热火山",
        "background": "活火山群的黑红地貌：橙红到暗黑的熔岩流、翻滚的火山灰与通红的山口微光。",
        "level": "岩浆湖上方的黑曜石平台，表面平整空旷。",
        "connection": "平台之间的熔岩河上浮桥或暗红热浪通道。",
        "start": "火山口边缘的观测站。",
    },
    {
        "name": "neon-city",
        "label": "霓虹都市",
        "background": "赛博朋克夜色都市：霓虹紫粉到墨蓝的楼宇剪影、全息广告与飘落的雨幕。",
        "level": "摩天楼顶的停机坪平台，表面干净空旷。",
        "connection": "楼宇之间的悬浮光轨或霓虹光带。",
        "start": "城市下层街区的入口平台。",
    },
]
